...
{
    Write-Output "Coffee requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Coffee blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Keybase in the #support chat channel:"
Write-Output "https://keybase.io/team/coffee_network.public"
Write-Output ""
Write-Output "Try the Quick Start Guide to running coffee-blockchain:"
Write-Output "https://github.com/Chia-Network/coffee-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI type '.\Install-gui.ps1' after '.\venv\scripts\Activate.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'coffee init' to begin."
