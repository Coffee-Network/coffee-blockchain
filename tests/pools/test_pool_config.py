...
from coffee.pools.pool_config import PoolWalletConfig
from coffee.util.config import load_config, save_config, create_default_coffee_config
...
def test_pool_config():
    ...
    create_default_coffee_config(test_root, ["config.yaml"])
