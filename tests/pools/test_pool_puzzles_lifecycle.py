...
from coffee.wallet.puzzles.p2_conditions import puzzle_for_conditions
from coffee.wallet.puzzles import singleton_top_layer
from coffee.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - coffee.pools.pool_puzzles.py
    - coffee.wallet.puzzles.pool_member_innerpuz.clvm
    - coffee.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
