...
from coffee.server.start_full_node import SERVICE_NAME
...
from coffee.consensus.pot_iterations import calculate_iterations_quality
from coffee.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
