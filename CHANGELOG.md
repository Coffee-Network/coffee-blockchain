...
- This is a hard fork/breaking change from RC6/7. TXCH Coins will **not** be moved forward but your plots and keys and parts of your configuration do. When you install this version before 10AM PDST on 3/16/2021 it will load up, start finding peers, and otherwise wait for the flag drop at that time to start farming. This is likely to be the last dress rehearsal for mainnet launch. Our [3/15/2021 blog post](https://www.coffee.net/2021/03/15/mainnet-update.html) has more details on the current mainnet launch plan.
...
- `coffee farm summary` will now display TXCH or XCH as appropriate.
...
- 'coffee wallet send' now takes in TXCH or XCH as units instead of mojos.
...
- The cli wallet, `coffee wallet`, was incorrectly displaying TXCH balances as if they were Coloured Coins.
...
- The user interface now refers to coffee coins with their correct currency code of XCH.
