...
from coffee.cmds.passphrase_funcs import prompt_for_passphrase, read_passphrase_from_file
from coffee.util.default_root import DEFAULT_KEYS_ROOT_PATH
from coffee.util.file_keyring import FileKeyring
from coffee.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE, KeyringWrapper
