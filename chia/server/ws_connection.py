...
from coffee.cmds.init_funcs import coffee_full_version_str
from coffee.protocols.protocol_message_types import ProtocolMessageTypes
from coffee.protocols.protocol_state_machine import message_response_ok
from coffee.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from coffee.protocols.shared_protocol import Capability, Handshake
from coffee.server.outbound_message import Message, NodeType, make_msg
from coffee.server.rate_limits import RateLimiter
...
from coffee.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from coffee.util.network import class_for_type, is_localhost

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4


class WSCoffeeConnection:
    """
