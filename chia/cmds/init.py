...
@click.option("--testnet", is_flag=True, help="Configure this coffee install to connect to the testnet")
...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, **kwargs):
    ...
    from coffee.cmds.passphrase_funcs import initialize_passphrase
...
if __name__ == "__main__":
    from .init_funcs import coffee_init
    from coffee.util.default_root import DEFAULT_ROOT_PATH

    coffee_init(DEFAULT_ROOT_PATH)
