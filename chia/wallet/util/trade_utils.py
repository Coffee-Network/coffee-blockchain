...
from coffee.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "coffee" in cc_discrepancies:
                    cc_discrepancies["coffee"] = cc_discrepancies["coffee"] + diff
                else:
                    cc_discrepancies["coffee"] = diff
