...
required to run a [Timelord](https://github.com/Chia-Network/coffee-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Chia-Network/coffee-blockchain/blob/main/install-timelord.sh)
