...
Write-Output "   ---"
Write-Output "Get COFFEE_INSTALLER_VERSION"
# The environment variable COFFEE_INSTALLER_VERSION needs to be defined
$env:COFFEE_INSTALLER_VERSION = python .\build_scripts\installer-version.py -win

if (-not (Test-Path env:COFFEE_INSTALLER_VERSION)) {
  $env:COFFEE_INSTALLER_VERSION = '0.0.0'
  Write-Output "WARNING: No environment variable COFFEE_INSTALLER_VERSION set. Using 0.0.0"
  }
Write-Output "Coffee Version is: $env:COFFEE_INSTALLER_VERSION"
Write-Output "   ---"
...
Write-Output "   ---"
Write-Output "Build coffee-blockchain wheels"
Write-Output "   ---"
pip wheel --use-pep517 --extra-index-url https://pypi.chia.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .

Write-Output "   ---"
Write-Output "Install coffee-blockchain wheels into venv with pip"
Write-Output "   ---"
...
Write-Output "pip install coffee-blockchain"
pip install --no-index --find-links=.\win_build\ coffee-blockchain
...
$appName = "Coffee"
$packageVersion = "$env:COFFEE_INSTALLER_VERSION"
...
jq --arg VER "$env:COFFEE_INSTALLER_VERSION" '.version=$VER' package.json > temp.json
rm package.json
