...
rm -rf ../venv || true
rm -rf venv || true
rm -rf coffee_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf coffee-blockchain-gui/build || true
rm -rf coffee-blockchain-gui/daemon || true
rm -rf coffee-blockchain-gui/node_modules || true
rm coffee-blockchain-gui/temp.json || true
( cd "$PWD/coffee-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
