...
from coffee.plotting.create_plots import resolve_plot_keys
from coffee.plotters.plotters_util import run_plotter, run_command
...
def plot_madmax(args, coffee_root_path: Path, plotters_root_path: Path):
